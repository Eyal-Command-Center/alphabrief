                ...
                <div className="bg-slate-900 border border-white/8 rounded-2xl p-6">
                  ...
                  <form onSubmit={handleAuth} className="space-y-3">
                    <input
                      ...
                      required
                      className="w-full bg-slate-800 border border-white/8 rounded-xl px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-emerald-500/60 text-sm transition-colors"
                    />
                    <input
                      type="password"
                      value={authPassword}
                    ...
                    <button
                      ...
                      className="w-full bg-emerald-500 hover:bg-emerald-400 disabled:bg-emerald-800 text-black font-semibold py-3 rounded-xl transition-all text-sm"
                    >
